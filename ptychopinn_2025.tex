...
overlap ($C_g=2$) + idealized probe & 71.34 & 86.53 & 0.952 & 0.996 \\
overlap ($C_g=2$) + experimental probe & 73.03 & 64.54 & 0.968 & 0.966 \\
\bottomrule
\end{tabular}
\end{table}
